...
import (
	...
	"k8s.io/ingress-gce/pkg/experimental/migconfig/client/clientset/versioned/scheme"
)
...
func (c *CloudV1alpha1Client) MigConfigs(namespace string) MigConfigInterface {
	return newMigConfigs(c, namespace)
}
