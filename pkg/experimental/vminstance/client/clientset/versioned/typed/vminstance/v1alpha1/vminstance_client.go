...
import (
	...
	"k8s.io/ingress-gce/pkg/experimental/vminstance/client/clientset/versioned/scheme"
)
...
func (c *CloudV1alpha1Client) VMInstances(namespace string) VMInstanceInterface {
